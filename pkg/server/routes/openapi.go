...
func (oa OpenAPI) InstallV2(c *restful.Container, mux *mux.PathRecorderMux) (*handler.OpenAPIService, *spec.Swagger) {
	...
	oa.Config.IgnorePrefixes = append(oa.Config.IgnorePrefixes,
		"/apis/quota.uccp.io/v1/clusterresourcequotas",
		"/apis/security.uccp.io/v1/securitycontextconstraints",
		"/apis/authorization.uccp.io/v1/rolebindingrestrictions",
		"/apis/authorization.uccp.io/v1/namespaces/{namespace}/rolebindingrestrictions",
		"/apis/authorization.uccp.io/v1/watch/namespaces/{namespace}/rolebindingrestrictions",
		"/apis/authorization.uccp.io/v1/watch/rolebindingrestrictions")
